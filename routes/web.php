...
Route::get('/', 'HomeController@index')
                ->name('home');
Route::get('/cart', 'HomeController@index1')
    ->name('home1');
...
Route::get('/login', 'LoginController@showLoginForm')->middleware('denglu')
                ->name('login');
...
Route::get('/page/{slug}', 'PageController@show')
                    ->name('page.show');
Route::any('minus/{slug}','CartController@minus')->name('minus');
Route::any('cart/{slug}','CartController@change')->name('add');
...
Route::middleware('front.auth')
    ...
    ->group(function () {
        ...
        Route::get('/my-account/address/{id}','AddressController@destroy')->name('address.destroy');
        Route::resource('/my-account/address', 'AddressController', ['as' => 'my-account'])->middleware('denglu');
