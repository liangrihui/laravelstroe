...
use AvoRed\Ecommerce\Http\Middleware\FrontGuest;
...
class Provider extends ServiceProvider
{
    ...
    protected function registerResources()
    {
        ...
        $this->loadTranslationsFrom(__DIR__.'/../resources/lang', 'avored-ecommerce');//为 空间avored-ecommerce 添加翻译文件
        $this->loadViewsFrom(__DIR__.'/../resources/views', 'avored-ecommerce');//先在默认视图中查找 没有再在这里查找
    }
    ...
    protected function registerMiddleware()
    {
        ...
        $router->aliasMiddleware('front.guest',FrontGuest::class);
    ...
    public function registerViewComposerData()
    {
        ...
        View::composer('layouts.*',LayoutAppComposer::class);
...
//        AdminMenuFacade::add('article')
//            ->label('文章')
//            ->route('#')
//            ->icon('fas fa-cart-plus');
//        $artcle = AdminMenuFacade::get('article');
//
//        $commMene = new AdminMenu();
//        $artcle->subMenu('article',$commMene);
     ...
     *注册发布文件
     * @return void    vendor:push config
     * 通过命令行工具使用 vendor:publish Artisan 命令 把文件复制到其所指定的位置
     * 包用户可以在发布文件时通过组标签来分开发布了：
