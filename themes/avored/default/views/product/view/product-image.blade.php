...
// dd( $product);
   ...
   // $imageType = (isset($imageType)) ? $imageType : "smallUrl";
    ...
    //$images = \AvoRed\Framework\Models\Database\ProductImage::where('product_id','=',$product->id)->first();
    //dd($image );
@endphp
                ...
                {{--@foreach($product->images as $productImage)--}}
                    ...
                    {{--<div class="carousel-item {{ $class }}">--}}
                        {{--<div class="media media-card">--}}
                            {{--<img src="{{ $image->other_path->smallUrl }}" data-main-image="{{ $image->other_path->url }}" class="img-thumbnail"/>--}}
                        {{--</div>--}}
                    {{--</div>--}}
                {{--@endforeach--}}
            {{--</div>--}}
