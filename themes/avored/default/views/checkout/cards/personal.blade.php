    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="form-group  col-6">
                <label class="control-label" for="input-user-last-name">姓</label>
            ...
            <div class="form-group  col-6">
                <label class="control-label" for="input-user-first-name">名</label>
        ...
        @if(!Auth::check())
            ...
            <div class="form-group">
                <label class="control-label" for="input-user-email">电子邮箱</label>
                <input
                        type="text"
                ...
                <div class="row">
                    <div class="form-group  col-6">
                        <label class="control-label"
                               for="input-billing-password">密码</label>
                    ...
                    <div class="form-group  col-6">
                        <label class="control-label" for="input-billing-confirm">确认密码</label>
        ...
        <div class="form-group">
            <label class="control-label" for="input-billing-phone">电话</label>
